...
class UploadView(FormView):
    ...
    def form_valid(self, form):
        ...
        for each in form.cleaned_data['files']:
            ...
            files_path = os.path.join(r'C:\Users\tap\Desktop\snapnote_django2\snapnote\media\files\pdfs', '*')
            ...
            for img in pdfimage.sequence:
                ...
                cnt2+=1
            target_dir = "C:\\Users\\tap\\Desktop\\snapnote_django2\\snapnote\\"
            ...
            if cnt==2:
                ...
                for i in range(halfcnt):
                    ...
                    blended.save(r'C:\Users\tap\Desktop\snapnote_django2\snapnote\media\files\pdfs\mergeImg\mergeResult' + str(i) + ".jpg")
                    #cnt3+=1
                for i in range(cnt2):
        ...
        dirname = r'C:\Users\tap\Desktop\snapnote_django2\snapnote\media\files\pdfs\mergeImg'
